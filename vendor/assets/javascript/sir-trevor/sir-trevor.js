...
/* Soundcloud */
  SirTrevor.Blocks.Soundcloud = SirTrevor.Block.extend({
    config: {
      regex: /<iframe width="100%" height="(\d+)" scrolling="no" frameborder="no"( allow="autoplay")? src="https?:\/\/w.soundcloud.com\/player\/\?url=https?%3A\/\/api\.soundcloud\.com\/(tracks|users|playlists)\/(\d+)([a-z0-9_;%&=]+)"><\/iframe>/,
